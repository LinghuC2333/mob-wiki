...
- interactive-fiction
sources:
- raw/2026-04-14-lunaverse-client-skill.md
...
> **2026-09-15 IDE 关联校准**：IDE 当前消费 LS 4.0.0，但不能据此认定这份独立 Cocos Client 或其线上安装已兼容。v3/v4、you/inner_thought 与有效发布身份须由消费者代码和部署验收证明；以下客户端阶段、事件与历史测试不在本次实现复验范围。
