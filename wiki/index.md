...
- [[concepts/ls-web-editor-asset-flow]] — LS 在线编辑器的角色与素材流程设计（2026-09-17）：先登记角色与服装标签、写作时按词表补全立绘名、素材页扫全书出清单再生图；三期落地，第一期 2026-09-17 在 feat/assets-phase1 完成
...
- [[entities/ls-web-editor]] — LS 在线编辑器（IDE-for-ugc）：CodeMirror 6 文本编辑加斜杠菜单，Next.js 16 + Prisma 6 + Google 登录，TS 轻量解析器做即时诊断、权威校验代理到 Railway lsc 服务；2026-09-16 立项，已上线 lunascripts.up.railway.app，2026-09-17 加语法手册与素材层第一期
